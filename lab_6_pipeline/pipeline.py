...
class CorpusManager:
    ...
    def _validate_dataset(self) -> None:
        ...
        indexed_files = [
            (int(get_article_id_from_filepath(meta)), meta, raw)
    ...
    def _scan_dataset(self) -> None:
        ...
        for file in self.path_to_raw_txt_data.glob("*_raw.txt"):
            article = from_raw(file, Article(url=None, article_id=get_article_id_from_filepath(file)))
            self._storage[get_article_id_from_filepath(file)] = article
